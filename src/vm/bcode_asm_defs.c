...
const bcode_asm_entry_t BCODE_ASM_TABLE[] = {
    ...
    [BCODE_PUSH_ENUM]      = { "PUSH_ENUM",      { BCODE_ASM_OP_NONE } },
    [BCODE_ENUM_VARIANT]   = { "ENUM_VARIANT",   { BCODE_ASM_OP_STR, BCODE_ASM_OP_I64 } },
    [BCODE_MAKE_ENUM]      = { "MAKE_ENUM",      { BCODE_ASM_OP_NONE } },
    [BCODE_PUSH_STRUCT]    = { "PUSH_STRUCT",    { BCODE_ASM_OP_NONE } },
    [BCODE_DEFINE_FIELD]   = { "DEFINE_FIELD",   { BCODE_ASM_OP_STR } },
    [BCODE_PUSH_TUPLE]     = { "PUSH_TUPLE",     { BCODE_ASM_OP_NONE } },
    [BCODE_APPEND_ELEM]    = { "APPEND_ELEM",    { BCODE_ASM_OP_NONE } },
    ...
    [BCODE_FIELD_GET]      = { "FIELD_GET",     { BCODE_ASM_OP_STR } },
    [BCODE_FIELD_SET]      = { "FIELD_SET",     { BCODE_ASM_OP_STR } },
